...
module Source =
    ...
    let add_or_update (source: Source) = ADD_OR_UPDATE.Execute source backbeat_db |> expect |> ignore
    ...
    let by_id (id: string) = BY_ID.Execute id backbeat_db |> expect |> Array.tryExactlyOne