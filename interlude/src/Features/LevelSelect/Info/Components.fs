...
type BottomInfo() =
    ...
    override this.Draw() =
        ...
        let three_icon_infos = this.Bounds.SliceT(70.0f).TranslateY(90.0f).ShrinkX(15.0f)
        ...
        let chart_info = this.Bounds.SliceT(30.0f).TranslateY(160.0f).ShrinkX(15.0f)
        ...
        let play_info = this.Bounds.SliceT(40.0f).TranslateY(185.0f).ShrinkX(15.0f)
