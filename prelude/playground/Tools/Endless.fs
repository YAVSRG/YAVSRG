...
let test() =
    ...
    let search_result = LibraryView.get_groups (FilterParts.parse search |> Filter.Build) Grouping.modes.["pack"] false Sorting.modes.["difficulty"] false false None ctx
