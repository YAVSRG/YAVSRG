...
module OsuClientParity =
    ...
    let TEST_REPLAY_FILE_2 = 
        OsuScoreDatabase_Score.ReadReplay "./Data/Percyqaz - Hachi - DONUT HOLE [Filling] (2024-09-30) OsuMania.osr"
