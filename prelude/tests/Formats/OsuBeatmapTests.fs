...
module OsuBeatmapTests =
    ...
    let TimingPoint_ValidParses () =
        ...
        timing_point_tc("2147483647,250.1,4,2,0,100,1,0", "2147483647,250,4,2,0,100,1,0")
        timing_point_tc("## PARSE ERROR", "2147483648,250,4,2,0,100,1,0")
        ...
        timing_point_tc("## PARSE ERROR", "100.1,250.1,0,2,0,100,1,0")
        ...
        timing_point_tc("100.1,250.1,2147483647,0,2,100,1,0", "100.1,250.1,2147483647,2,0,100,1,0")
        ...
        timing_point_tc("## PARSE ERROR", "100.1,250.1,4,0,-2147483649,100,1,0")
        timing_point_tc("## PARSE ERROR", "100.1,250.1,4,0,,100,1,0")
        timing_point_tc("## PARSE ERROR", "100.1,250.1,4,0,1.1,100,1,0")
        timing_point_tc("## PARSE ERROR", "100.1,250.1,4,0,AAA,100,1,0")
        timing_point_tc("100.1,250.1,4,0,1,100,1,0", "100.1,250.1,4,0,  1  ,100,1,0")

        // Volume
        timing_point_tc("100.1,250.1,4,2,0,0,1,0", "100.1,250.1,4,2,0,-1")
        timing_point_tc("100.1,250.1,4,2,0,0,1,0", "100.1,250.1,4,2,0,0")
        ...
        // Effects
        timing_point_tc("100.1,250.1,4,2,0,100,1,0", "100.1,250.1,4,2,0,100,1,-2147483649")
        timing_point_tc("100.1,250.1,4,2,0,100,1,0", "100.1,250.1,4,2,0,100,1,2147483648")
        ...
        timing_point_tc("100.1,250.1,4,2,0,100,1,0", "100.1,250.1,4,2,0,100,1,")
        timing_point_tc("100.1,250.1,4,2,0,100,1,0", "100.1,250.1,4,2,0,100,1,AAA")
        timing_point_tc("100.1,250.1,4,2,0,100,1,0", "100.1,250.1,4,2,0,100,1,1.1")
