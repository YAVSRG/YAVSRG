...
module OsuBeatmapTests =
    ...
    let TimingPoint_ValidParses () =
        ...
        timing_point_tc("## PARSE ERROR", "1e100,250.1")
        timing_point_tc("## PARSE ERROR", "-1e100,250.1")
        timing_point_tc("## PARSE ERROR", "2147483648,250.1")
        timing_point_tc("## PARSE ERROR", "-2147483649,250.1")
        timing_point_tc("-2147483648,250.1,4,0,0,100,1,0", "-2147483648,250.1")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", " 100.1,250.1")

        // MsPerBeat
        timing_point_tc("100.1,500,4,0,0,100,1,0", "100.1,")
        timing_point_tc("100.1,500,4,0,0,100,1,0", "100.1,AAA")
        timing_point_tc("100.1,500,4,0,0,100,1,0", "100.1,NaN")
        timing_point_tc("100.1,1E+100,4,0,0,100,1,0", "100.1,1e100")
        timing_point_tc("100.1,2147483648,4,0,0,100,1,0", "100.1,2147483648")
        timing_point_tc("100.1,500,4,0,0,100,1,0", "100.1,-1e100")
        timing_point_tc("100.1,500,4,0,0,100,1,0", "100.1,-1")
        timing_point_tc("100.1,500,4,0,0,100,1,0", "100.1,0")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1, 250.1")

        // Meter
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,0")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,-1")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,AAA")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,NaN")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,1e100")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,-1e100")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,2147483648")
        timing_point_tc("100.1,250.1,2147483647,0,0,100,1,0", "100.1,250.1,2147483647")
        timing_point_tc("100.1,250.1,3,0,0,100,1,0", "100.1,250.1,3")
        timing_point_tc("100.1,250.1,3,0,0,100,1,0", "100.1,250.1, 3")

        // SampleSet
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,-1")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,4")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,AAA")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,1.1")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,Default")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,None")
        timing_point_tc("100.1,250.1,4,1,0,100,1,0", "100.1,250.1,4,Normal")
        timing_point_tc("100.1,250.1,4,2,0,100,1,0", "100.1,250.1,4,Soft")
        timing_point_tc("100.1,250.1,4,3,0,100,1,0", "100.1,250.1,4,Drum")
        timing_point_tc("100.1,250.1,4,1,0,100,1,0", "100.1,250.1,4, 1")

        // SampleIndex
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,AAA")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,-2147483649")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,2147483648")
        timing_point_tc("100.1,250.1,4,0,-2147483648,100,1,0", "100.1,250.1,4,0,-2147483648")
        timing_point_tc("100.1,250.1,4,0,2147483647,100,1,0", "100.1,250.1,4,0,2147483647")
        timing_point_tc("100.1,250.1,4,0,2,100,1,0", "100.1,250.1,4,0, 2")

        // Volume
        timing_point_tc("100.1,250.1,4,0,0,0,1,0", "100.1,250.1,4,0,0,-1")
        timing_point_tc("100.1,250.1,4,0,0,0,1,0", "100.1,250.1,4,0,0,0")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,0,")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,0,AAA")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,0,1e100")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,0,-1e100")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,0,NaN")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,0,101")
        timing_point_tc("100.1,250.1,4,0,0,50,1,0", "100.1,250.1,4,0,0, 50")

        // Uninherited
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,0,100,1")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,0,100,100")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,0,100,1A")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,0,100,1.1")
        // Inherited
        // In osu!lazer this test case parses as Uninherited -- todo: bug report?
        timing_point_tc("100.1,-100,4,0,0,100,0,0", "100.1,250.1,4,0,0,100, 1")
        timing_point_tc("100.1,-100,4,0,0,100,0,0", "100.1,250.1,4,0,0,100,\"1\"")
        timing_point_tc("100.1,-100,4,0,0,100,0,0", "100.1,250.1,4,0,0,100,AAA")
        timing_point_tc("100.1,-100,4,0,0,100,0,0", "100.1,250.1,4,0,0,100,")
        timing_point_tc("100.1,-100,4,0,0,100,0,0", "100.1,250.1,4,0,0,100,0")
        timing_point_tc("100.1,-100,4,0,0,100,0,0", "100.1,250.1,4,0,0,100,2")
        timing_point_tc("100.1,-100,4,0,0,100,0,0", "100.1,250.1,4,0,0,100,-1")
        // Inherited: Multiplier
        timing_point_tc("100.1,-50,4,0,0,100,0,0", "100.1,-50,4,0,0,100,0")
        timing_point_tc("100.1,-1,4,0,0,100,0,0", "100.1,-0.1,4,0,0,100,0")
        timing_point_tc("100.1,-10000,4,0,0,100,0,0", "100.1,-100000,4,0,0,100,0")
        timing_point_tc("100.1,-100,4,0,0,100,0,0", "100.1,0,4,0,0,100,0")
        timing_point_tc("100.1,-100,4,0,0,100,0,0", "100.1,NaN,4,0,0,100,0")
        timing_point_tc("100.1,-100,4,0,0,100,0,0", "100.1,1e100,4,0,0,100,0")
        timing_point_tc("100.1,-1,4,0,0,100,0,0", "100.1,-1e-100,4,0,0,100,0")
        timing_point_tc("100.1,-10000,4,0,0,100,0,0", "100.1,-1e100,4,0,0,100,0")

        // Effects
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,0,100,1,-2147483649")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,0,100,1,2147483648")
        timing_point_tc("100.1,250.1,4,0,0,100,1,-2147483648", "100.1,250.1,4,0,0,100,1,-2147483648")
        timing_point_tc("100.1,250.1,4,0,0,100,1,2147483647", "100.1,250.1,4,0,0,100,1,2147483647")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,0,100,1,")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,0,100,1,AAA")
        timing_point_tc("100.1,250.1,4,0,0,100,1,0", "100.1,250.1,4,0,0,100,1,1.1")
        timing_point_tc("100.1,250.1,4,0,0,100,1,1", "100.1,250.1,4,0,0,100,1, 1")
