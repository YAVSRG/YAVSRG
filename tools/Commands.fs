...
module Commands =
    ...
    let register (ctx: ShellContext) =
        ctx
            ...
            .WithCommand("skin_add", "Add a local skin to YAVSRG's skin repo", "folder_name", Noteskins.add_skin)
            ...
            .WithCommand("backbeat_upload", "Upload a local folder of charts to YAVSRG's chart network", "folder_name", Backbeat.Upload.upload_folder)
